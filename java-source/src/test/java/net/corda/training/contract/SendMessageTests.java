 ...
 * The objective here is to write some contract code that verifies a transaction to issue an {@link }.
 * As with the {@link MessageStateTests} uncomment each unit test and run them one at a time. Use the body of the tests and the
