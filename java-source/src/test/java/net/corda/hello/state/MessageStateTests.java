 ...
 * to the left of the {@link MessageStateTests} class or the [hasIOUAmountFieldOfCorrectType()] method.
 * Running the unit tests from {@link MessageStateTests} runs all of the unit tests defined in the class.
